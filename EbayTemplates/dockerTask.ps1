...
.PARAMETER Clean
Removes the image ebaytemplates and kills all containers based on that image.
...
Build a Docker image named ebaytemplates
#>
...
$imageName="ebaytemplates"
$projectName="ebaytemplates"
$serviceName="ebaytemplates"
